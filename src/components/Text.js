  ...
  return (
    <div className="row" id="section1" style={{ backgroundColor: "#1b1464" }}>
      ...
      <div className="col m-5 mt-3">
        ...
        perspiciatis provident suscipit eaque ut perferendis? Dolorem veniam
        quod reprehenderit expedita impedit ipsam eaque excepturi esse, ea
        fugiat, facere cumque cupiditate voluptatem.
      </div>
    </div>
  );
};
