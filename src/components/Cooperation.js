const Cooperation = () => {
  return (
    <div className="row justify-content-between " id="section4" style={{ backgroundColor: "rgb(51,52,51)" }}>
      ...
      <div className="col-md-3 col-sm-12 shadow-lg p-md-3 mx-md-4 bg-dark rounded my-5">
        <div className="text-center">
          <div className="text-warning">CHŁODNIE</div>
          <div className="coop-title">IFS</div>
          <div>Logistics</div>
        </div>
          ...
          <div className="accordion-item bg-dark">
            <h2 className="accordion-header bg-dark" id="headingOne">
              <button
                ...
                data-bs-target="#chłodnie1"
                aria-expanded="false"
                aria-controls="chłodnie1"
              >
                Jan Kowalski
              </button>
            </h2>
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="headingTwo">
              <button
                ...
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#chłodnie2"
                aria-expanded="false"
                aria-controls="chłodnie2"
              >
                Paweł Kowalski
              </button>
            </h2>
          ...
          <div className="accordion-item">
            <h2 className="accordion-header" id="headingThree">
              <button
                ...
                type="button"
                data-bs-toggle="collapse"
                data-bs-target="#chłodnie3"
                aria-expanded="false"
                aria-controls="chłodnie3"
